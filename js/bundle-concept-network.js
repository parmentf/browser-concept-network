...
require.define("concept-network",function(require,module,exports,__dirname,__filename,process,global){module.exports.ConceptNetwork = require('./lib/concept-network').ConceptNetwork;
module.exports.ConceptNetworkState = require('./lib/concept-network-state').ConceptNetworkState;

});

require.define("/home/francois/dev/browser-concept-network/lib/concept-network",function(require,module,exports,__dirname,__filename,process,global){/*jshint node:true, maxlen:80, curly: true, eqeqeq: true, immed: true,
...
require.define("/home/francois/dev/browser-concept-network/lib/concept-network-state",function(require,module,exports,__dirname,__filename,process,global){/*jshint node:true, maxlen:80, curly: true, eqeqeq: true, immed: true,
 latedef: true, newcap: true, noarg: true, sub: true, undef: true,
 eqnull: true, laxcomma: true, indent: 2, white:true */
 /*
